...
pub type CoreExpr<FX> = sappho_ast_core::CoreExpr<Pattern, PureExpr, QueryExpr, Expr<FX>, FX>;
...
pub type ObjectDef<FX> = sappho_ast_core::ObjectDef<Pattern, PureExpr, QueryExpr, Expr<FX>>;
